...
public class BackgroundUpdate extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... params) {
        ...
        //String update_URL = "http://172.16.10.56/clearDues.php";
        String update_URL = "http://" + MainActivity.ip +"clearDues.php";

        if(type.equals("update")){
            try {
                String flat_no = params[1];
                String dues = params[2];
                ...
                String post_data = URLEncoder.encode("flat_no", "UTF-8")+"="+URLEncoder.encode(flat_no, "UTF-8")+"&"
                        ...
                        + URLEncoder.encode("dues", "UTF-8")+"="+URLEncoder.encode(dues, "UTF-8")+"&"
